...
// com.googleusercontent.apps.YOUR_CLIENT_ID in android manifest
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final simpleAuth.GoogleApi googleApi = new simpleAuth.GoogleApi("google",
      "1003016421236-4tdd3ftjpvofmd6co8veevh036s5ffpn.apps.googleusercontent.com",
      "redirecturl",
      clientSecret: "lHwzyA9WjRxnqrB1khiMbMLf",
      scopes: [
          ...
          ListTile(
            ...
            onTap: () async {
              try {
                ...
                showMessage("Hello");
                showMessage("${user.toJson()} logged in");
              } catch(e) {
                showError("error");
              }
            },
